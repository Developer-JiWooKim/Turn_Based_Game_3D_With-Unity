...
public class UnitOrderBySpeedSystem
{
    ...
    public void OrderBySpeed(List<BattleUnit> units)
    {
        ...
        _units.Sort((a, b) => b.Speed.CompareTo(a.Speed) == 0 ? _random.Next(-1, 2) : b.Speed.CompareTo(a.Speed));

        _currentIndex = 0;

        _currentUnit = _units.Count > 0 ? _units[_currentIndex] : null;
    }

    /// <summary>
    /// 현재 유닛을 반환하는 메소드, 유닛 리스트가 비어있으면 null을 반환
    /// </summary>
